...
public class DD_Arrow : MonoBehaviour
{
    [SerializeField] 
    private Sprite spriteArrowMustHit;

    [SerializeField]
    private Sprite spriteArrow;

    [SerializeField]
    private Sprite spriteTailMustHit;

    [SerializeField]
    private SpriteRenderer spriteRendererArrow;
    
    [SerializeField]
    private SpriteRenderer spriteRendererTail;
    ...
    public bool IsPress { get => isPress; set => isPress = value; }
